...
## AS SOON AS WE UPLOD THE IMAGE AND WILL GET THE RESPONSE FROM IT.
...
# Streamlit 
st.set_page_config(page_title="Vision Diet App", page_icon="🍽", layout="centered")
st.header("Vision Diet App")
...
You are an expert nutritionist where you need to see the food items from the image 
        ...
        nutrients required in our diet.
